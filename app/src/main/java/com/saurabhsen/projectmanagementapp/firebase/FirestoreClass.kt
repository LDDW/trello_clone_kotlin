package com.trello.clone.firebase
...
import com.trello.clone.ui.activities.*
    ...
    fun createBoard(activity: CreateBoardActivity, board: Board){
        mFireStore
            ...
            .addOnSuccessListener {
                ...
                Toast.makeText(activity, "Tableau créer", Toast.LENGTH_SHORT).show()
    ...
    fun updateBoard(activity: CreateBoardActivity, board: Board){
        ...
        mFireStore
            ...
            .addOnSuccessListener {
                ...
                Toast.makeText(activity, "Tableau mis à jour", Toast.LENGTH_SHORT).show()
                activity.boardCreatedSuccessfully()
            }
            .addOnFailureListener {
                activity.hideProgressDialog()
    ...
    fun updateUserProfileData(activity: Activity, userHashMap: HashMap<String, Any>){
        mFireStore
            ...
            .addOnSuccessListener {
                ...
                Toast.makeText(activity, "Profile mis à jour", Toast.LENGTH_SHORT).show()
                when(activity){
                    is MainActivity -> {
