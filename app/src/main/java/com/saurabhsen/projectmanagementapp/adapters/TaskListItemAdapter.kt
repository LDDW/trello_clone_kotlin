package com.trello.clone.adapters
...
import com.trello.clone.models.Task
import com.trello.clone.ui.activities.TaskListActivity
        ...
        if(holder is MyViewHolder){
            ...
            holder.itemView.ib_done_list_name.setOnClickListener {
                ...
                if(listName.isNotEmpty()){
                    ...
                    Toast.makeText(context, "Veuillez saisir le nom de la liste", Toast.LENGTH_SHORT).show()
                }
            }
